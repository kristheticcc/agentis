...
def main():
    ...
    print(profile_parser("61 year old male with stage 2 pancreatic cancer, currently taking gemcitabine, no prior radiation, no prior immunotherapy, otherwise healthy with good organ function."))
    print("-----------------------------------------------------------------")
